                  ...
                  <ul class="aa-product-catg">
                     ...
                     @if(isset($product[0]))
                       @foreach($product as $productArr)
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="{{url('product/'.$productArr->slug)}}"><img src="{{asset('storage/products/'.$productArr->image)}}" alt="{{$productArr->name}}" style=" height: 300px;width: 100%"></a>
