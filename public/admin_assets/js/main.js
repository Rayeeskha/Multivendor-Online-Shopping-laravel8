...
function update_payment_status(order_id){
  let check = confirm('Are you sure you want to change payment status');
  let payment_status = $('#payment_status').val();
  if (check == true) {
    window.location.href = '/admin/update_payment_status/'+order_id+'/'+payment_status;
  }
}


function update_order_status(order_id){
  let check = confirm('Are you sure you want to change Order status');
  let order_status = $('#order_status').val();
  if (check == true) {
    window.location.href = '/admin/update_order_status/'+order_id+'/'+order_status;
  }
}